class PlayerManager {
  ...
  registerPlayer(playerName, timeToDestination, attackGroup = 1, groupId = null, sendTime = null) {
    if ((!timeToDestination || timeToDestination <= 0) && (sendTime === null || sendTime === undefined)) {
      throw new Error('Time to destination must be greater than 0 or send time must be provided');
    }
    ...
    this.players.set(playerName, {
      name: playerName,
      timeToDestination: timeToDestination || 0,
